...
- Storage - Not the the best compression ratio,  but the option is there.
...
- Recommended to use windows ISO's builds 22000+. Always official sources, unless you're trying to analyze malware. (vhdx-boot w/host-partition-lock is a great way to do this...)

::$-h-@-Z-Z-@-m! A native command shell Windows image deployment tool. ~ (C) Joshua Cline
...
EXIT /B
:AUTOPILOT_EXAMPLE
IF NOT DEFINED AUTOPILOT_VHDX IF DEFINED VHDX_SOURCE_$ETUP SET "AUTOPILOT_VHDX=%VHDX_SOURCE_$ETUP%"
IF NOT DEFINED AUTOPILOT_VHDX IF DEFINED VHDX_SOURCE_IMAGE SET "AUTOPILOT_VHDX=%VHDX_SOURCE_IMAGE%"
IF NOT DEFINED AUTOPILOT_VHDX SET "AUTOPILOT_VHDX=123.VHDX"
(ECHO;:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
ECHO;:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
ECHO.ECHO AUTOPILOT * YOUR SCRIPT GOES HERE
ECHO.PAUSE
...
REM DISKMGR_DISKMGR_DISKMGR_DISKMGR_DISKMGR_DISKMGR_DISKMGR_
REM DISKMGR_DISKMGR_DISKMGR_DISKMGR_DISKMGR_DISKMGR_DISKMGR_
@ECHO OFF&&SET "DISK_LETTER="&&IF NOT DEFINED COLOR_SLOT SET "CLRTMP=%RANDOM%%RANDOM%"&&SET "CLRTMP=!CLRTMP:~5,5!"&&SET "CLRTMP=!CLRTMP:~1,1!"&&CALL COLOR %CLRTMP%
CLS&&TITLE  [%CD%\] $-h-@-Z-Z-@-m^^! A native command shell Windows image deployment tool.&&IF DEFINED COLOR_SLOT COLOR %COLOR_SLOT%
IF DEFINED PROG_OPER CALL:TITLECARD_NML
...
IF NOT DEFINED VHDX_SLOT_$ETUP SET "VHDX_SLOT_$ETUP=1"
IF NOT DEFINED COLOR_SLOT SET "CLRTMP=%RANDOM%%RANDOM%"&&SET "CLRTMP=!CLRTMP:~5,5!"&&SET "CLRTMP=!CLRTMP:~1,1!"&&CALL COLOR %CLRTMP%
CLS&&TITLE  [%CD%\] $-h-@-Z-Z-@-m^^! A native command shell Windows image deployment tool.&&IF DEFINED COLOR_SLOT COLOR %COLOR_SLOT%
IF DEFINED PROG_OPER CALL:TITLECARD_NML
...
IF NOT DEFINED PROG_OPER IF NOT "%VHDX_SOURCE_$ETUP%"=="-SELECT-" IF "%BCD_SYSTEM%"=="SLOT" ECHO     {M}ode[%BCD_SYSTEM%] {S}lot[%VHDX_SLOT_$ETUP%]       {G}o^^!     ~ {V} Copy %VHDX_SOURCE_$ETUP%} ~ &&CALL:PAD_LINE
IF DEFINED PROG_OPER ECHO                  Enter File # To [%PROG_OPER%] {/}Type&&CALL:PAD_LINE
ECHO                Press (Enter) to Return to Previous Menu
CALL:MENU_SELECT&&IF DEFINED PROG_OPER CALL:FILE_LIST>NUL
IF NOT DEFINED PROG_OPER IF NOT DEFINED SELECT GOTO:PROG_MAIN
...
IF DEFINED PART_QUIT SET "BOOT_ERROR=PARTITION CREATION FAILURE. COULD BE PAGEFILE ISSUE. PREPARE FOR POSSIBLE CRASH. REBOOT INTO RECOVERY TO FORCE."&&GOTO:BOOT_CLEANUP
:BOOT_CREATE
DISM /cleanup-MountPoints>NUL 2>&1
...
IF DEFINED BOOT_ERROR ECHO %BOOT_ERROR%&&SET "BOOT_ERROR="&&PAUSE&&EXIT /B
...
IF "%BCD_SYSTEM%"=="SLOT" FOR %%a in (9 8 7 6 5 4 3 2 1 0) DO (CALL SET "BCD_CNT=%%a"&&CALL:BCD_VHDX)
...
COPY /Y "%SYSTEMDRIVE%\Windows\System32\config\ELAM" "%BCD_FILE%">NUL 2>&1
REG LOAD HKLM\%BCD_KEY% "%BCD_FILE%">NUL 2>&1
...
REG.exe delete "HKLM\%BCD_KEY%" /v "FirmwareModified" /f>>"%MAKER_FOLDER%\PACKAGE.CMD"
REG UNLOAD HKLM\%BCD_KEY%>NUL 2>&1
...
IF NOT "%BCD_CNT%"=="0" BCDEDIT.EXE /STORE "%BCD_FILE%" /displayorder %BCD_GUID% /addfirst
IF "%BCD_CNT%"=="0" BCDEDIT.EXE /STORE "%BCD_FILE%" /displayorder %BCD_GUID% /addlast
EXIT /B
::_TAG

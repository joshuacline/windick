...
EXIT /B
:VHDX_SLOT_$ETUP
SET /A VHDX_SLOT_$ETUP+=1&&IF "%VHDX_SLOT_$ETUP%" EQU "9" SET "VHDX_SLOT_$ETUP=0"
IF "%VHDX_SLOT_$ETUP%" GTR "%BCDSLOT_CNT%" SET "VHDX_SLOT_$ETUP=0"
EXIT /B
:BCDSLOT_CNT
SET /A BCDSLOT_CNT+=1&&IF "%BCDSLOT_CNT%" EQU "9" SET "BCDSLOT_CNT=0"
...
EXIT /B
:MAKER_SLOT
SET /A MAKER_SLOT+=1&&IF "%MAKER_SLOT%" GEQ "5" SET "MAKER_SLOT=1"
SET "MAKER_FOLDER=%PROG_SOURCE%\Project%MAKER_SLOT%"
EXIT /B
:PACK_COMPRESS

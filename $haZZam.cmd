...
@ECHO OFF&&SETLOCAL ENABLEDELAYEDEXPANSION&&SET "ORIG_CD=%CD%"&&CD /D "%~DP0"&&SET $VER_CUR=1110
...
@ECHO OFF&&CLS&&CALL:TITLEGEN&&CALL:SETS_HANDLER&&CALL:FOLDER_LOCATE&&CALL:OBJ_EXIST&&CALL:IMAGE_EXIST&&CALL:COLOR_CHK&&CALL:PAD_LINE&&SET "MOUNT="
...
IF NOT EXIST "%%a\*" IF NOT DEFINED LIVE_APPLY DISM /IMAGE:"%APPLYDIR_MASTER%" /ADD-DRIVER /DRIVER:"%%a" /ForceUnsigned>$DRVR

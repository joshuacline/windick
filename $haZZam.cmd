...
SET BASE_TYPE=
CALL:PAD_LINE&&ECHO                          End of List Creation&&CALL:PAD_LINE&&CALL:TITLECARD&&SET /P "PAUSED=Press (ENTER) to continue..."
EXIT /B
...
SET "DISK_LETTER="&&IF DEFINED PROG_OPER SET PROG_OPER=&&CALL:PAD_LINE&&ECHO	                      End of Disk-Part Operation&&CALL:PAD_LINE&&PAUSE
GOTO:DISKMGR_START
...
IF "%PROG_OPER%"=="GOTIME" SET CAME_FROM=$ETUP&&CALL:BOOT_MAKER&&SET /P "PAUSED=Press (ENTER) to continue..."
...
SET SVC_MODE=&&SET /P "PAUSED=Press (ENTER) to continue..."
...
ECHO ~ NEXT, PRESS {C} TO CREATE THE PACK, PUT IN A $PK LIST, AND TEST^^! ~&&SET /P "PAUSED=Press (ENTER) to continue..."
ECHO;@ECHO OFF>>%MAKER_FOLDER%\PACKAGE.CMD"

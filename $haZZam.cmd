...
IF NOT "%PROG_MODE%"=="RAMDISK" IF "%PAD_STYLE%"=="8" CALL:PAD_LINE >NUL
CALL:MENU_SELECT
...
IF "%PAD_STYLE%"=="8" IF DEFINED TRIPPY SET "TRIPPY="&&SET "PAD_CHNK=\\\\\\\\\\"&&GOTO:PAD_JUMP
IF "%PAD_STYLE%"=="8" IF NOT DEFINED TRIPPY SET "TRIPPY=1"&&SET "PAD_CHNK=//////////"
:PAD_JUMP
...
IF NOT DEFINED PROG_OPER ECHO.&&ECHO  {P}adding Style  [%PAD_STYLE%]
...
IF "%SELECT%"=="P" SET /A PAD_STYLE+=1&&IF "%PAD_STYLE%"=="8" SET "PAD_STYLE=1"&&GOTO:$ETTINGS_START

...
IF NOT DEFINED PROG_OPER IF "%FOLDER_MODE%"=="ISOLATED" IF NOT "%PROG_MODE%"=="RAMDISK" ECHO                        {-}BOOT[FOLDER]IMAGE{+}&&CALL:PAD_LINE
IF NOT DEFINED PROG_OPER IF "%FOLDER_MODE%"=="UNIFIED" IF "%PROG_MODE%"=="RAMDISK" ECHO                     ~ {R}ebuild as [%BCD_SYSTEM%-MODE] } ~&&CALL:PAD_LINE
IF NOT DEFINED PROG_OPER IF "%FOLDER_MODE%"=="ISOLATED" IF "%PROG_MODE%"=="RAMDISK" ECHO     {-}BOOT[FOLDER]IMAGE{+}          ~ {R}ebuild as [%BCD_SYSTEM%-MODE] } ~&&CALL:PAD_LINE

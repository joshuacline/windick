...
IF EXIST "Z:\" SET "DISK_LETTER=Z"&&CALL:VDISK_DETACH>NUL 2>&1
...
IF "%OBJ_IMAGEMGR%"=="VHDX" IF "%PROG_OPER%"=="PICK" IF EXIST "Z:\" SET "DISK_LETTER=Z"&&CALL:VDISK_DETACH&&SET PROG_OPER=&&GOTO:IMAGEMGR_START
IF "%OBJ_IMAGEMGR%"=="VHDX" IF "%PROG_OPER%"=="PICK" SET "VDISK=%IMAGE_FOLDER%\%SELECT%"&&SET "DISK_LETTER=Z"&&CALL:VDISK_ATTACH
...
IF "%OBJ_IMAGEMGR%"=="VHDX" IF "%PROG_OPER%"=="NEW" IF DEFINED NEW_VDISK IF DEFINED VHDX_SIZE SET "DISK_LETTER=Y"&&CALL:VDISK_CREATE
IF "%OBJ_IMAGEMGR%"=="VHDX" IF "%PROG_OPER%"=="NEW" IF DEFINED NEW_VDISK IF DEFINED VHDX_SIZE SET "DISK_LETTER=Y"&&CALL:VDISK_DETACH&&ECHO 
...
SET "DISK_LETTER=Z"&&CALL:VDISK_CREATE>NUL 2>&1

...
CALL:EFI_UNMOUNT>NUL 2>&1
IF "%BCD_SYSTEM%"=="NAME" IF NOT "%VHDX_SOURCE_$ETUP%"=="-SELECT-" ECHO COPYING %VHDX_SOURCE_$ETUP%...&&COPY /Y "\\?\%IMAGE_FOLDER%\%VHDX_SOURCE_$ETUP%" "%LAST_LETTER%:\$">NUL 2>&1
IF "%BCD_SYSTEM%"=="SLOT" IF NOT "%VHDX_SOURCE_$ETUP%"=="-SELECT-" ECHO COPYING %VHDX_SOURCE_$ETUP%...&&COPY /Y "\\?\%IMAGE_FOLDER%\%VHDX_SOURCE_$ETUP%" "%LAST_LETTER%:\$\1.VHDX">NUL 2>&1
...
:BCD_CREATE
REM BCD_CREATE_BCD_CREATE_BCD_CREATE_BCD_CREATE_BCD_CREATE_BCD_CREATE_BCD_CREATE
IF NOT DEFINED BCD_SYSTEM SET "BCD_SYSTEM=SLOT"&&SET "BCD_SYSTEM_TEMP=1"

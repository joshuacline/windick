...
$HSIZ = [int](40 * $ScaleRef * $ScaleFactor)
$XLOC = [int](10 * $ScaleRef * $ScaleFactor)
$YLOC = [int](80 * $ScaleRef * $ScaleFactor)
...
$WSIZ = [int](135 * $ScaleRef * $ScaleFactor)
$HSIZ = [int](45 * $ScaleRef * $ScaleFactor)
$XLOC = [int](225 * $ScaleRef * $ScaleFactor)
$YLOC = [int](375 * $ScaleRef * $ScaleFactor)
$okButton.Location = New-Object System.Drawing.Point($XLOC, $YLOC)
$okButton.Size = New-Object Drawing.Size($WSIZ,$HSIZ)
$okButton.Cursor = 'Hand'
$okButton.ForeColor = 'White'
...
$WSIZ = [int](325 * $ScaleRef * $ScaleFactor)
$HSIZ = [int](110 * $ScaleRef * $ScaleFactor)
$XLOC = [int](90 * $ScaleRef * $ScaleFactor)
$YLOC = [int](333 * $ScaleRef * $ScaleFactor)
$labelbox.Location = New-Object System.Drawing.Point($XLOC, $YLOC)
$labelbox.Size = New-Object Drawing.Size($WSIZ, $HSIZ)
$labelbox.AutoSize = $true
...
$PageSP = NewPanel -C '51' -X '250' -Y '0' -W '750' -H '666';$PageMain.Controls.Add($PageSP)
...
$PageLBWiz = NewPanel -C '25' -X '0' -Y '0' -W '1000' -H '666';$form.Controls.Add($PageLBWiz);$PageLBWiz.Visible = $false;
$PageLEWiz = NewPanel -C '25' -X '0' -Y '0' -W '1000' -H '666';$form.Controls.Add($PageLEWiz);$PageLEWiz.Visible = $false;
$PagePB = NewPanel -C '51' -X '250' -Y '0' -W '750' -H '666';$PageMain.Controls.Add($PagePB);$PagePB.Visible = $false
$PagePBWiz = NewPanel -C '25' -X '0' -Y '0' -W '1000' -H '666';$form.Controls.Add($PagePBWiz);$PagePBWiz.Visible = $false;
$PagePEWiz = NewPanel -C '25' -X '0' -Y '0' -W '1000' -H '666';$form.Controls.Add($PagePEWiz);$PagePEWiz.Visible = $false;
...
$GroupBoxName = 'Group1';$GroupBox1_PageSC = NewGroupBox -X '15' -Y '85' -W '260' -H '75' -Text 'Console Window'
...
$Page = 'PageMain';$pictureBase64 = $logobar;$PictureBox1_PageMain = NewPictureBox -X '0' -Y '636' -W '40' -H '30';$PictureBox1_PageMain.BringToFront();$Button_SP = NewPageButton -X '-5' -Y '631' -W '50' -H '47' -C '0' -Text '*'
$form.ResumeLayout()
